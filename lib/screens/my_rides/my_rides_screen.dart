  ...
  final List<Map<String, String>> published = [
    {
      ...
      "end": "11:00 AM",
      "price": "540",
      "published_date": "25 Sep 2025",
      "published_time": "06:00 AM",
      "status": "Open",
    },
    {
      "publishedId": "501",
    ...
    return ListView.builder(
      ...
      itemBuilder: (_, i) {
        ...
        return _rideCard(
          ...
          publishedTime: d["published_time"],
        );
      },
    );
  }
      ...
      child: Card(
        child: Column(
          children: [
            ...
            // DIFFERENT FOOTER BASED ON TYPE
            if (type == "request")
              _requestFooter(theme, name, rating!)
            else if (type == "published")
              _publishedFooter(theme, publishedDate, publishedTime)
            else
              _normalFooter(theme, name, rating),
          ],
        ),
      ),
    );
      ...
      child: Column(
        ...
        children: [
          ...
          ListTile(
            ...
            title: Text(publishedDate ?? "", style: theme.bodyMedium),
            subtitle: Text(publishedTime ?? "", style: theme.bodySmall),
