...
import 'package:runaar/repos/vehicle/active_vehicle_repo.dart';

class ActiveVehicleProvider extends ChangeNotifier {
  ...
  Future<void> vehicleList({required int userId}) async {
    ...
    notifyListeners();
    try {
      final result = await activeVehicleRepo.vehicleList(userId: userId);
      _response = result;
