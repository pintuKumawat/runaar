...
required int trip_id,required int user_id,required int seat_request,int, required double total_price,required String payment_method,required String payment_status,required String special_message  
})async{
  ...
  return apiMethods.post(endpoint: "booking/request", body: body, onSuccess: (responseData){
